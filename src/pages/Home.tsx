      ...
      <section className="relative pt-32 pb-24 px-4 overflow-hidden bg-gradient-to-br from-background via-white to-primary/5">
        ...
        <div className="container mx-auto text-center max-w-5xl relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="#what-is">
              <Button size="lg" className="bg-primary hover:bg-purple text-primary-foreground hover:text-purple-foreground font-semibold text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                Learn More
